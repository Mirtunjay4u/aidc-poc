...
Checkpoint `95134ea - Add AWS AIDC repo bootstrap note` completes the current AWS readiness package alignment after the AWS infrastructure handoff and AWS readiness evidence template.
